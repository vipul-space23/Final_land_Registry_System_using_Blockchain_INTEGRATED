...
// --- NEW METAMASK PREREQUISITE MODAL ---
const MetamaskModal = ({ onClose }) => (
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
    <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full m-4 transform transition-all duration-300 scale-100">
      ...
      <p className="text-gray-600 mb-6">
        To use our blockchain platform, you need a Web3 wallet. Please download and install <strong>MetaMask</strong> to continue.
      </p>
      <ul className="list-disc list-inside space-y-2 text-gray-600 mb-8">
        <li>MetaMask is a secure wallet for your digital assets.</li>
        <li>It allows this website to interact with the blockchain.</li>
        <li>You maintain full control over your funds and data.</li>
      </ul>
      <a
        href="https://metamask.io/download/"
        target="_blank"
        rel="noopener noreferrer"
        className="w-full flex items-center justify-center py-3 px-6 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-semibold rounded-xl shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 hover:scale-105"
      >
        Download MetaMask
        {/* External Link Icon */}
...
const MainDashboard = () => {
  ...
  const handleLogin = async () => {
    // 1. Check for MetaMask prerequisite
    if (!window.ethereum) {
      setShowMetamaskModal(true);
      return; // Stop execution if MetaMask is not found
    }

    // 2. If MetaMask is installed, connect wallet
    await connectWallet();
    
    // 3. Navigate to the single /login page as requested
    navigate('/login');
  };
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans antialiased bg-gray-50 overflow-x-hidden">
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-10">
              ...
              {/* CTA */}
              <div className="flex flex-col sm:flex-row gap-4">
                {/* --- MODIFIED HERO BUTTON: Changed <a> to <Link> --- */}
                <Link 
                  to="/login"
                  className="group relative px-8 py-4 bg-blue-600 text-white font-bold rounded-none hover:bg-blue-700 transition-all duration-200 overflow-hidden"
                >
      ...
      {/* --- RENDER THE METAMASK MODAL IF STATE IS TRUE --- */}
