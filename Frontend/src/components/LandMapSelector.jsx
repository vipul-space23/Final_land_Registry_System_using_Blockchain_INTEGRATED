...
// // Import marker icons directly using ESM imports
// import icon from 'leaflet/dist/images/marker-icon.png';
// import iconShadow from 'leaflet/dist/images/marker-shadow.png';
// import iconRetina from 'leaflet/dist/images/marker-icon-2x.png';

// // Create a new default icon instance and assign it to Leaflet's marker prototype
// // This is the correct way to handle default icons in a bundled environment like Vite or Create React App.
...
// // Component to find user's location and center the map
// const LocateUser = ({ onPositionFound }) => {
//     const map = useMap();
//     useEffect(() => {
...
//             // Default to Mumbai, India if location fails
//             const mumbaiCoords = { lat: 19.0760, lng: 72.8777 };
//             map.setView(mumbaiCoords, 13);
//             onPositionFound(mumbaiCoords);
//         });
//     }, [map, onPositionFound]);
//     return null;
// };
...
//         // Get the center of the drawn shape or the pin's location
//         if (layerType === 'marker') {
//             center = layer.getLatLng();
//         } else { // For rectangles and polygons
//             center = layer.getBounds().getCenter();
//         }
        
//         if (center) {
//             // Send coordinates to parent component, rounded to 6 decimal places
//             onAreaSelect({ lat: center.lat.toFixed(6), lng: center.lng.toFixed(6) });
//         }
//     };
...
//                 Use the drawing tools on the map to mark your property. You can draw a rectangle, a polygon, or drop a pin. The latitude and longitude will be automatically captured in the form above.
//             </p>
//             <div className="h-96 w-full rounded-lg overflow-hidden border border-gray-300" style={{ zIndex: 0 }}>
//                {/* Show a loading state until the map is centered */}
//                 {!mapCenter ? (
//                     <div className="h-full w-full flex items-center justify-center bg-gray-200 animate-pulse">
//                         <p className="text-gray-600">Loading Map & Finding Your Location...</p>
//                     </div>
//                 ) : (
//                     <MapContainer
//                         center={mapCenter}
...
//                                     rectangle: true,
//                                     polygon: true,
//                                     marker: true, // This is the "pin"
//                                     circle: false,
//                                     circlemarker: false,
//                                     polyline: false,
//                                 }}
//                                 edit={{
//                                     // We only allow creating one shape at a time for simplicity
//                                     // Users can delete and redraw.
//                                     edit: false, 
//                                     remove: true, 
//                                 }}
//                             />
//                         </FeatureGroup>
//                         <LocateUser onPositionFound={setMapCenter} />
//                     </MapContainer>
//                 )}
//             </div>
//         </div>
