...
// //   // Use a default location if props are missing
...
// //       <MapContainer
// //         center={position}
// //         zoom={geometry ? 15 : 13} // Zoom in closer if no geometry
...
// //         {/* 1. Show the marker for the main coordinate */}
// //         {latitude && longitude && (
// //           <Marker position={position}>
// //             <Popup>{address || `Location: ${lat}, ${lng}`}</Popup>
// //           </Marker>
// //         )}

// //         {/* 2. Show the drawn shape (polygon/rectangle) */}
// //         {geometry && (
// //           <GeoJSON data={geometry} style={shapeStyle} />
// //         )}

// //         {/* 3. Automatically zoom to fit the shape */}
...
//       <MapContainer
//         center={position}
//         // If we have a shape, FitBounds will take over. If not, use a default zoom.
...
//         {/* 2. Show the marker only if there is NO shape */}
//         {/* This prevents a marker from showing up in the middle of a polygon */}
